...
const routes: Record<string, string> = {
    ...
    'configuracoes.integrations': '/configuracoes/integrations-list',
    'configuracoes.visual_settings': '/configuracoes/estilo',
    'configuracoes.appearance.update': '/configuracoes/aparencia',
