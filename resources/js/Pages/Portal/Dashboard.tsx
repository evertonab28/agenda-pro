...
export default function Dashboard({
    ...
    useEffect(() => {
        (window as any).axios
            .get(`/api/p/${workspace.slug}/charges`)
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <header className="bg-white border-b shadow-sm sticky top-0 z-10">
                <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                        <Link
                            href={route("portal.profile", workspace.slug)}
                        ...
                        <Link
                            href={route("portal.logout", workspace.slug)}
                            method="post"
                            as="button"
            ...
            <main className="max-w-5xl mx-auto p-4 py-8 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card
                        className="hover:shadow-lg transition-all cursor-pointer border-indigo-100 group"
                        onClick={() =>
                    ...
                    >
                        ...
                        <CardContent className="pt-2">
                            ...
                            <p className="text-sm text-slate-500">
                                Veja seus horários confirmados e histórico
                                detalhado.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card
                        className="hover:shadow-lg transition-all cursor-pointer border-slate-100 group md:col-span-2"
                        onClick={() =>
                            (window.location.href = route(
                                "portal.profile",
                                workspace.slug,
                    ...
                    >
                        ...
                        <CardContent className="pt-2">
                            ...
                            <p className="text-sm text-slate-500">
                                Mantenha seus dados de contato e preferências
                                atualizados.
                            </p>
                        </CardContent>
                    </Card>
                ...
                <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-2xl p-8 text-white flex flex-col items-center justify-center space-y-6 shadow-xl shadow-indigo-200">
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-indigo-100 opacity-90 max-w-sm mx-auto">
                            Agende seu próximo atendimento agora mesmo de forma
                            rápida e segura.
                        </p>
                    </div>
                    <Button
